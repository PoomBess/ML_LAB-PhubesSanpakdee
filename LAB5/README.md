...
## Description
ในแล็บนี้เป็นการศึกษาและพัฒนาโมเดลจำแนกประเภทรูปภาพ (Image Classification) สำหรับผลไม้ ได้แก่ แอปเปิ้ล กล้วย  โดยใช้ภาษา Python และ Machine Learning / Deep Learning Frameworks ซึ่งมีขั้นตอนหลัก ดังนี้:
